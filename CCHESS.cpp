   ...
   else
   {
    ...
    while(!qx.empty())
    {
       ...
       if(visited[sx+2][sy-1]==0&&(sy-1)>0)
       {
           ...
           qy.push(sy-1);
           visited[sx+2][sy-1]=1;
           dist[sx+2][sy-1]=dist[sx][sy]+sx*(sx+2)+(sy)*(sy-1);
       }
       else
       {
           if(dist[sx+2][sy-1]>dist[sx][sy]+sx*(sx+2)+(sy)*(sy-1))
           {
                    qx.push(sx+2);
                    qy.push(sy-1);
                    visited[sx+2][sy-1]=1;
       ...
       if(visited[sx+1][sy+2]==0)
       {
           ...
           qy.push(sy+2);
           visited[sx+1][sy+2]=1;
           dist[sx+1][sy+2]=dist[sx][sy]+sx*(sx+1)+(sy)*(sy+2);
       }
       else
       {
           if(dist[sx+1][sy+2]>dist[sx][sy]+sx*(sx+1)+(sy)*(sy+2))
           {
                    qx.push(sx+1);
                    qy.push(sy+2);
                    visited[sx+1][sy+2]=1;
